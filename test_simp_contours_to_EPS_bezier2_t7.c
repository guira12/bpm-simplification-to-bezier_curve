...
simplifie tous les contours selon des beziers2 (avec un seuil d)
...
int main(int argc, char **argv){
  ...
  if(argc!=4){
    ...
    tot_B=simp_PBM_to_EPS_bezier2(argv[1], argv[2], d);
    printf("NOMBRE TOTAL DE BEZIER 2 APRES SIMPLIFICATION AVEC d=%lf:\n%u\n",d,tot_B);   
  }
  return 0;
}